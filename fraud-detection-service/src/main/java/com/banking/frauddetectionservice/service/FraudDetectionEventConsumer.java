...
public class FraudDetectionEventConsumer {
    ...
    // we are validating the transaction from the event pushed in to kafka by transaction service
    //every transaction will undergo check from fraud detection service
